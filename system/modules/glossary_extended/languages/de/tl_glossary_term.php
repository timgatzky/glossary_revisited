...
$GLOBALS['TL_LANG']['tl_glossary_term']['addImage']     = array('Ein Bild oder mehrere Bilder hinzufügen', 'Der Definition ein Bild oder mehrere Bilder hinzufügen.');
...
$GLOBALS['TL_LANG']['tl_glossary_term']['published']    = array('Veröffentlichen', 'Diese Definition veröffentlichen');
...
$GLOBALS['TL_LANG']['tl_glossary_term']['publish_legend']  	 = 'Veröffentlichung';
...
$GLOBALS['TL_LANG']['tl_glossary_term']['toggle'] = array('Begriff veröffentlichen', 'Begriff ID %s veröffentlicht');